...
import static service.UpkeepTaskTest.STATUS_PENDING;

public class UpkeepTaskTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 创建管理员菜单
        AdminMenu adminMenu = new AdminMenu(upkeepTaskDAO, upkeepStaffDAO);
...
//        String taskStatus = scanner.nextLine();
        ...
        // 创建养护任务对象
        UpkeepTask newUpkeepTask = new UpkeepTask(taskId, plantId, staffId, taskDescription,STATUS_PENDING);
